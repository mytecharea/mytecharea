    ...
    <div class="page-container">
      <section class="section contact-section">
        ...
        <div class="contact-buttons">
          ...
          <a href="https://wa.me/9606472035?text=Hi%20Niraj,%20I%20would%20like%20to%20discuss%20about%20project%20delopment." class="btn btn-whatsapp" target="_blank" rel="noopener noreferrer" (click)="onWhatsAppClick()">
          ...
          <p *ngIf="autoReply()" class="auto-reply">Thanks for your enquiry about web devlopment, our team will reach out you shortly!</p>
...
export class ContactComponent {
  protected readonly autoReply = signal(false);
